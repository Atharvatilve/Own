...
function setup(){
    ...
    log6 = new Smooth(400,140,900, PI/2);
    log7 = new Smooth(900,140,900,PI/2);
    log8 = new Smooth(750,240,900,PI/2);
    log9 = new Smooth(750,240,900,PI/2);
    log10 = new Smooth(750,240,900,PI/2);
